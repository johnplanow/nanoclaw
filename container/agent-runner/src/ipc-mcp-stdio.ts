...
Example: A message contains <attachment id="slack:media:1709123456789-abc123" name="photo.jpg" type="image/jpeg" />
→ Call get_media with media_id="slack:media:1709123456789-abc123"
